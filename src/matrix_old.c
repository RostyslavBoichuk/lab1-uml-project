/**
 * @file matrix_old.c
 * @brief Legacy procedural implementation of a Matrix Calculator.
 *
 * This file contains the original implementation of the matrix calculator
 * using static 10x10 arrays and global loop variables.
 *
 * It demonstrates procedural programming style before refactoring
 * into an object-oriented design.
 *
 * @warning This is legacy code and contains poor architectural practices
 * such as global variables and fixed-size arrays.
 */

#include <stdio.h>

/**
 * @brief Global loop variables used across functions.
 *
 * @details These variables are used for iteration in multiple
 * matrix operations. Using global loop variables is considered bad practice.
 */
int i, j, k; // for Loops
 ...
 *
 * @param array Matrix with fixed size 10x10.
 ...
 *
 * @param arrayone First matrix.
 * @param arraytwo Second matrix.
 * @param rows Number of rows.
 * @param columns Number of columns.
 */
...
/**
 * @brief Subtracts two matrices and prints the result.
 *
 * @param arrayone First matrix.
 * @param arraytwo Second matrix.
 * @param rows Number of rows.
...
/**
 * @brief Multiplies a matrix by a scalar and prints the result.
 *
...
/**
 * @brief Computes and prints transpose of a matrix.
 *
 * @param arrayone Input matrix.
 * @param rows Number of rows.
 * @param columns Number of columns.
 */
